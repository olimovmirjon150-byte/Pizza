...
export default function CartPage() {
  ...
  if (items.length === 0) {
    return (
      <div className="container" style={{ fontFamily: "Proxima Nova, sans-serif" }}>
        <div className="d-flex flex-column align-items-center justify-content-center vh-100 text-center">
          <h2 className="fw-bold mb-3" style={{ fontSize: "32px" }}>
            Корзина пустая <span role="img" aria-label="sad">😕</span>
          </h2>
          <p className="text-muted mb-5" style={{ fontSize: "18px", maxWidth: "550px" }}>
  ...
  return (
    <div>
      <Header />
    <div className="container py-5" style={{ fontFamily: "Proxima Nova, sans-serif", maxWidth: "800px" }}>
      <div className="d-flex justify-content-between align-items-center mb-5">
        ...
        >
          <span className="me-2">🗑</span> Очистить корзину
        </div>
      </div>

      <div className="cart-items">
        {items.map((item) => (
          <div key={item.id} className="d-flex align-items-center justify-content-between py-4 border-top">
            <div className="d-flex align-items-center gap-3" style={{ width: "40%" }}>
              ...
              <div>
                ...
                <p className="text-muted mb-0">{item.type} тесто, {item.size} см.</p>
              </div>
            </div>
            ...
            <div className="fw-bold" style={{ fontSize: "22px", width: "100px", textAlign: "right" }}>
      ...
      <div className="d-flex justify-content-between mt-5">
        ...
        <div style={{ fontSize: "20px" }}>
          Сумма заказа: <b className="ms-1" style={{ color: "#fe5f1e" }}>{totalPrice} ₽</b>
        </div>
      </div>
      ...
      <div className="d-flex justify-content-between mt-5">
        ...
        <button 
          className="btn text-white px-5 py-3 rounded-pill fw-bold"
